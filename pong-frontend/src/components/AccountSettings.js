...
function AccountSettings({ isLoggedIn }) {
  return (
    <div className="h-screen w-screen flex items-center justify-center bg-gray-900 text-white">
      {/* Conditional Rendering based on login status */}
      {isLoggedIn ? (
        <div className="p-8 bg-gray-800 rounded-lg shadow-lg w-full max-w-lg">
          <h1 className="text-4xl font-bold mb-4 text-blue-400">Account Settings</h1>
          <p className="text-lg text-gray-400 mb-6">Manage your account details below:</p>
